...
export const directorOptions: DropdownOption[] = [
  ...
  { value: 'Ron Clements', label: 'Clements, Ron' },
  {
    ...
    label: 'Clements, Ron & Musker, John',
  },
  ...
  {
    value: 'Bobby Farrelly & Peter Farrelly',
    label: 'Farrelly, Bobby & Farrelly, Peter',
  },
  ...
  {
    value: 'Jason Friedberg & Aaron Seltzer',
    label: 'Friedberg, Jason & Seltzer, Aaron',
  },
  ...
  { value: 'Richard Linklater', label: 'Linklater, Richard' },
  {
    ...
    label: 'Lord, Phil & Miller, Christopher',
  },
  ...
  {
    value: 'Michael Spierig & Peter Spierig',
    label: 'Spierig, Michael & Spierig, Peter',
  },
  ...
  { value: 'Thomas Vinterberg', label: 'Vinterberg, Thomas' },
  {
    ...
    label: 'Wachowski, Lana & Wachowski, Lilly',
  },
...
export const genreOptions: DropdownOption[] = [
  ...
  { value: 'RomCom@Romantic Comedy', label: 'Romantic Comedy' },
...
export const subGenreOptions: DropdownOption[] = [
  ...
  {value: "Gangster & Mob/Mafia@Gangsters & Mob/Mafia", label: "Gangster & Mob/Mafia"},
